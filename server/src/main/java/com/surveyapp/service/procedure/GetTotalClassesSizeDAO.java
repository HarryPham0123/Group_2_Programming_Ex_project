...
public class GetTotalClassesSizeDAO {
    private String procedureQuery = "{CALL getTotalClassesSize(?, ?, ?, ?, ?, ?, ?)}";
    private Connection connection = null;
    private CallableStatement statement;
    private ResultSet resultSet = null;

    public GetTotalClassesSizeDAO setParameters(Code code) throws SQLException {
    ...
    public String executeProcedure() throws Exception {
        try {
            ...
            System.out.println("Total classes: " + result);
            return result;
        } finally {
            if (resultSet != null) {
                try {
