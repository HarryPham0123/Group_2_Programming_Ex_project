...
-- call call pe2018.GetTotalClassesSize('A2020Y', 'S002q', NULL , 'P004E', 'M007A', NULL , 'C007q') -- null faculty code and class code -- 35

-- All parameters are null parameters
-- call pe2018.GetTotalClassesSize(NULL, NULL, NULL, NULL, NULL, NULL, NULL) -- return the sum(c.size) -- 711
...
-- call pe2018.GetTotalClassesSize('this', 'is', 'just', 'a', 'random', 'test', 'nice') -- return the sum(c.size) -- 711
